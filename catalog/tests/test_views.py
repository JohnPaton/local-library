...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        # Direct assignment of many-to-many types is not allowed.
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        due_dates = [
            bi.due_back for bi in response.context["bookinstance_list"]
        ]
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        # Manually check redirect (Can't use assertRedirect, because
        # the redirect URL is unpredictable)
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_url_reverse(self):
        self.assertEqual(reverse("author_create"), "/catalog/author/create/")
    ...
    def test_no_initial_values(self):
        ...
        [
            self.assertIsNone(v)
            for v in response.context["form"].initial.values()
        ]
    ...
    def test_author_created(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response, reverse("author-detail", kwargs={"pk": 1})
        )

        author = Author.objects.get(pk=1)
        self.assertEqual(author.first_name, "John")
        self.assertEqual(author.last_name, "Doe")
        self.assertEqual(author.date_of_birth, datetime.date(2000, 1, 1))
